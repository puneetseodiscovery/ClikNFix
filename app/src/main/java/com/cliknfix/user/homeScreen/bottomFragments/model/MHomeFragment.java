...
public class MHomeFragment implements IMHomeFragment {
    ...
    public MHomeFragment(PHomeFragment pHomeFragment) {
        this.ipHomeFragment = pHomeFragment;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case APIInterface.GETCATEGORYLIST_SUCCESS:
                    ...
                    ipHomeFragment.getCategoriesListSuccessResponse(categoriesListResponseModel);
                    break;
                case APIInterface.GETCATEGORYLIST_FAILED:
                    String message = (String) msg.obj;
                    ipHomeFragment.getCategoriesListFailureResponse(message);
                    break;
            }
        }
    };
